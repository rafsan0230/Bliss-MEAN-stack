...
const getMailOptions = (receiver, prescription) => {
  let mailOptions = {
    from: "bliss.therapyservice@gmail.com",
    to: receiver,
    subject: "Appointment for Therapy",
    html: `<!DOCTYPE html>
        ...
        <div align="center" class="alignment" style="line-height:10px"><a href="https://www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="your logo" src="https://res.cloudinary.com/dleacvdtv/image/upload/v1678006522/logo-white_peimff.png" style="display: block; height: auto; border: 0; width: 155px; max-width: 100%;" title="your logo" width="155"/></a></div>
        </td>
        </tr>
        </table>
        </td>
        ...
        <p style="margin: 0;">Bliss.therapyservice@gmail.com</p>
        </div>
        </td>
        </tr>
        </table>
